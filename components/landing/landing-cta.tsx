        ...
        <div className="relative rounded-3xl bg-gradient-to-br from-signal via-signal/95 to-ink-950 p-8 sm:p-14 lg:p-20 text-white shadow-2xl shadow-signal/25 overflow-hidden text-center">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link
                href="/register"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-white text-signal font-bold text-base shadow-xl hover:bg-white/95 hover:scale-[1.02] transition-all duration-150 tap-active"
              >
              ...
              <Link
                href="/login"
                className="w-full sm:w-auto inline-flex items-center justify-center px-7 py-4 rounded-xl bg-white/10 hover:bg-white/20 text-white font-semibold text-base border border-white/20 backdrop-blur-sm transition-colors tap-active"
              >
                J&apos;ai déjà un compte
              </Link>
            </div>
