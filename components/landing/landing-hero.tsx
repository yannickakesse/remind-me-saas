    ...
    <section className="relative pt-32 pb-16 md:pt-44 md:pb-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 mb-14">
          <Link
            href="/register"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-8 py-4 rounded-full bg-signal text-white font-semibold text-sm sm:text-base shadow-lg shadow-signal/25 hover:bg-signal-dark hover:shadow-xl hover:shadow-signal/30 btn-premium tap-active group"
          >
