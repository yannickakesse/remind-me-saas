    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-xl border border-ink-200 bg-canvas-raised shadow-xs">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <span>+</span> Programmer une dépense
          </button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {filtered.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="p-4 rounded-xl border border-ink-200 bg-canvas-raised shadow-xs flex flex-col justify-between space-y-4 hover:border-ink-300 transition-colors"
              >
                <div>
