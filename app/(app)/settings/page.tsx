...
export default async function SettingsPage() {
  ...
  const [{ data: profile }, { data: userSettings }, { data: subscription }, { data: countries }, { data: currencies }] =
    await Promise.all([
      supabase
        .from("profiles")
    ...
    <div>
      ...
      <Tabs
        items={[
          ...
          { id: "notifications", label: "Notifications", content: <NotificationsSection notifPrefs={userSettings?.notif_prefs ?? null} /> },
